                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" placeholder="Codigo del producto">
                                </div>            
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    <label>Costo S/</label>
                                    <input type="text" class="form-control" id="cost" name="cost" value="0.00" placeholder="0.00">
                                </div>            
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" data-date-format="dd-mm-yyyy" id="dueDate" name="dueDate" class="form-control datetimepicker-input"/>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="custom-control custom-switch pt-4">
                                    <input type="checkbox" class="custom-control-input" id="useInventory" name="useInventory">
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    <label>Stock</label>
                                    <input type="text" class="form-control" id="stock" name="stock" value="0" disabled placeholder="0">
                                </div>            
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
                                    <label>Stock Minimo</label>
                                    <input type="text" class="form-control" id="minStock" name="minStock" value="0" disabled placeholder="0">
                                </div>            
                            </div>
                        </div>
                    </div>    
