...
<div class="modal fade" id="modalExpense" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="" method="POST" id="frmAddYapeExpense">    
        @csrf
        <input type="hidden" id="yapeexpenseId" name="yapeexpenseId">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="addYapeExpense" type="button" class="btn btn-primary">Guardar</button>
