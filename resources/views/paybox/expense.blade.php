        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label>Gasto S/</label>
                                <input type="text" class="form-control" id="expense" name="expense" placeholder="0.00" @if($paybox->state==2) disabled @endif>
                            </div>            
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button id="addPayBoxExpense" type="button" class="btn btn-primary">Guardar</button>
