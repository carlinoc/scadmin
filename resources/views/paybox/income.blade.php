...
<div class="modal fade" id="incomeModal" aria-labelledby="addModalLabel" aria-hidden="true">
    <form action="" method="POST" id="frmAddIncome">    
        @csrf
        <input type="hidden" name="payboxIncomeId" id="payboxIncomeId">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="income" name="income" placeholder="0.00" @if($paybox->state==2) disabled @endif>
                            </div>            
                        </div>
                    </div>
                    <div class="form-group">
