    ...
    async function fetchStaff() {
        ...
        _dtStaff.DataTable({
            ...
            "columns": [
                ...
                {
                    "render": function(data, type, row, meta) {
                        return '<a href="#" data-index="'+meta.row+'" class="btn btn-sm btn-info editStaff"><i class="far fa-edit"></i></a> <a href="#" data-id="'+row.id+'" class="btn btn-sm btn-danger removeStaff"><i class="far fa-trash-alt"></i></a>';
                    }
                }
            ]
        });    
