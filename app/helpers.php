...
class Myhelpers{
    public static function numberToLetter(float $monto)
    {
        ...
        return Myhelpers::NumerosALetras($monto).$texto_con; 
    }

    public static function NumerosALetras($monto) 
    {
        $maximo = pow(10,9);
        ...
        {            
            switch ($base) {
                ...
                case 2: return array_key_exists($monto, $decena)  ? $decena[$monto]  : $prefijo_decena[$pren*10]   . Myhelpers::NumerosALetras($resto);
                case 3: return array_key_exists($monto, $centena) ? $centena[$monto] : $prefijo_centena[$pren*100] . Myhelpers::NumerosALetras($resto);
                case 4: case 5: case 6: return ($prencentena>1) ? Myhelpers::NumerosALetras($prencentena). " ". $sufijo_miles . " " . Myhelpers::NumerosALetras($restocentena) : $sufijo_miles. " " . Myhelpers::NumerosALetras($restocentena);
                case 7: case 8: case 9: return ($prenmillar>1)  ? Myhelpers::NumerosALetras($prenmillar). " ". $sufijo_millones . " " . Myhelpers::NumerosALetras($restomillar)  : $sufijo_millon. " " . Myhelpers::NumerosALetras($restomillar);
            }
        } else {
