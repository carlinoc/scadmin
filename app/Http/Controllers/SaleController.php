...
class SaleController extends Controller
{
    ...
    public function show(Request $request): View
    {
        ...
        return view('sales.show', ['sale' => $sale, 'products' => $products, 'salesDetails' => $salesDetails, 'tables' => $tables, 'clients' => $clients]);
    }
    ...
    public function sendboleta(Request $request)
    {
        ...
        if($client->dni==""){
            return response()->json(['status'=>'error', 'message'=>'Para emitir una BOLETA es necesario el DNI del cliente']);
        }
